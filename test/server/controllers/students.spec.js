...
describe('/api/students', () => {
  ...
  test('GET /?gmail=1', async done => {
    ...
    expect(res.body[0].name).toEqual('JOSE FERREIRA SILVA')
    expect(res.body[0].registrationNumber).toEqual('200504940003')
    expect(res.body[0].crg).toBeDefined()
    expect(res.body[0].course).toEqual('cbsi')
    expect(res.body[0].email).toEqual('naosouativo@gmail.com')
    expect(res.body[0].isFit).toEqual(0)
    expect(res.body[0].isConcluding).toEqual(1)
    expect(res.body[0].isActive).toEqual(0)
    expect(res.body[0].isForming).toEqual(0)
    expect(res.body[0].isGraduating).toEqual(0)
    expect(res.body[0].academicHighlight).toEqual(0)
    expect(res.body[0].cancelled).toEqual(0)
    expect(res.body[0].prescribed).toEqual(0)
    expect(res.body[0].mailingList).toEqual('none')

    expect(res.body[1].id).toEqual(4)
    expect(res.body[1].name).toEqual('ENZO FERREIRA ALVES')
    expect(res.body[1].registrationNumber).toEqual('201104940004')
    expect(res.body[1].crg).toBeDefined()
    expect(res.body[1].course).toEqual('cbcc')
    expect(res.body[1].email).toEqual('slug@gmail.com')
    expect(res.body[1].isFit).toEqual(0)
    expect(res.body[1].isConcluding).toEqual(0)
    expect(res.body[1].isActive).toEqual(1)
    expect(res.body[1].isForming).toEqual(0)
    expect(res.body[1].isGraduating).toEqual(0)
    expect(res.body[1].academicHighlight).toEqual(0)
    expect(res.body[1].cancelled).toEqual(0)
    expect(res.body[1].prescribed).toEqual(0)
    expect(res.body[1].mailingList).toEqual('none')

    expect(res.body[2].id).toEqual(5)
    expect(res.body[2].name).toEqual('KAUAN CARVALHO SANTOS')
    expect(res.body[2].registrationNumber).toEqual('200604940005')
    expect(res.body[2].crg).toBeDefined()
    expect(res.body[2].course).toEqual('cbcc')
    expect(res.body[2].email).toEqual('dofuturo@gmail.com.br')
    expect(res.body[2].isFit).toEqual(0)
    expect(res.body[2].isConcluding).toEqual(0)
    expect(res.body[2].isActive).toEqual(0)
    expect(res.body[2].isForming).toEqual(0)
    expect(res.body[2].isGraduating).toEqual(0)
    expect(res.body[2].academicHighlight).toEqual(0)
    expect(res.body[2].cancelled).toEqual(1)
    expect(res.body[2].prescribed).toEqual(0)
    expect(res.body[2].mailingList).toEqual('none')
    done()
  })
  ...
  test('GET /?', async done => {
    ...
    expect(res.body[0].name).toEqual('FELIPE SOUZA FERREIRA')
    expect(res.body[0].registrationNumber).toEqual('201704940001')
    expect(res.body[0].crg).toBeDefined()
    expect(res.body[0].course).toEqual('cbcc')
    expect(res.body[0].email).toEqual('notgoo@gmiau.com')
    expect(res.body[0].isFit).toEqual(0)
    expect(res.body[0].isConcluding).toEqual(0)
    expect(res.body[0].isActive).toEqual(1)
    expect(res.body[0].isForming).toEqual(1)
    expect(res.body[0].isGraduating).toEqual(0)
    expect(res.body[0].academicHighlight).toEqual(0)
    expect(res.body[0].cancelled).toEqual(0)
    expect(res.body[0].prescribed).toEqual(0)
    ...
    expect(res.body[1].name).toEqual('LAURA CARDOSO CASTRO')
    expect(res.body[1].registrationNumber).toEqual('201304940002')
    expect(res.body[1].crg).toBeDefined()
    expect(res.body[1].course).toEqual('cbsi')
    expect(res.body[1].email).toEqual('youngboy@yahoo.com')
    expect(res.body[1].isFit).toEqual(0)
    expect(res.body[1].isConcluding).toEqual(1)
    expect(res.body[1].isActive).toEqual(0)
    expect(res.body[1].isForming).toEqual(0)
    expect(res.body[1].isGraduating).toEqual(0)
    expect(res.body[1].academicHighlight).toEqual(0)
    expect(res.body[1].cancelled).toEqual(0)
    ...
    expect(res.body[2].name).toEqual('JOSE FERREIRA SILVA')
    expect(res.body[2].registrationNumber).toEqual('200504940003')
    expect(res.body[2].crg).toBeDefined()
    expect(res.body[2].course).toEqual('cbsi')
    expect(res.body[2].email).toEqual('naosouativo@gmail.com')
    expect(res.body[2].isFit).toEqual(0)
    expect(res.body[2].isConcluding).toEqual(1)
    expect(res.body[2].isActive).toEqual(0)
    expect(res.body[2].isForming).toEqual(0)
    expect(res.body[2].isGraduating).toEqual(0)
    expect(res.body[2].academicHighlight).toEqual(0)
    expect(res.body[2].cancelled).toEqual(0)
    expect(res.body[2].prescribed).toEqual(0)
    expect(res.body[2].mailingList).toEqual('none')

    expect(res.body[3].id).toEqual(4)
    expect(res.body[3].name).toEqual('ENZO FERREIRA ALVES')
    expect(res.body[3].registrationNumber).toEqual('201104940004')
    expect(res.body[3].crg).toBeDefined()
    expect(res.body[3].course).toEqual('cbcc')
    expect(res.body[3].email).toEqual('slug@gmail.com')
    expect(res.body[3].isFit).toEqual(0)
    expect(res.body[3].isConcluding).toEqual(0)
    expect(res.body[3].isActive).toEqual(1)
    expect(res.body[3].isForming).toEqual(0)
    expect(res.body[3].isGraduating).toEqual(0)
    expect(res.body[3].academicHighlight).toEqual(0)
    expect(res.body[3].cancelled).toEqual(0)
    expect(res.body[3].prescribed).toEqual(0)
    expect(res.body[3].mailingList).toEqual('none')

    expect(res.body[4].id).toEqual(5)
    expect(res.body[4].name).toEqual('KAUAN CARVALHO SANTOS')
    expect(res.body[4].registrationNumber).toEqual('200604940005')
    expect(res.body[4].crg).toBeDefined()
    expect(res.body[4].course).toEqual('cbcc')
    expect(res.body[4].email).toEqual('dofuturo@gmail.com.br')
    expect(res.body[4].isFit).toEqual(0)
    expect(res.body[4].isConcluding).toEqual(0)
    expect(res.body[4].isActive).toEqual(0)
    expect(res.body[4].isForming).toEqual(0)
    expect(res.body[4].isGraduating).toEqual(0)
    expect(res.body[4].academicHighlight).toEqual(0)
    expect(res.body[4].cancelled).toEqual(1)
    expect(res.body[4].prescribed).toEqual(0)
    expect(res.body[4].mailingList).toEqual('none')

    expect(res.body[5].id).toEqual(6)
    expect(res.body[5].name).toEqual('EDUARDO ALVES LIMA')
    expect(res.body[5].registrationNumber).toEqual('201804940006')
    expect(res.body[5].crg).toBeDefined()
    expect(res.body[5].course).toEqual('cbcc')
    expect(res.body[5].email).toEqual('oldfashioned33@hotmail.com')
    expect(res.body[5].isFit).toEqual(0)
    expect(res.body[5].isConcluding).toEqual(0)
    expect(res.body[5].isActive).toEqual(1)
    expect(res.body[5].isForming).toEqual(0)
    expect(res.body[5].isGraduating).toEqual(0)
    expect(res.body[5].academicHighlight).toEqual(0)
    expect(res.body[5].cancelled).toEqual(0)
    expect(res.body[5].prescribed).toEqual(0)
    expect(res.body[5].mailingList).toEqual('none')

    expect(res.body[6].id).toEqual(7)
    expect(res.body[6].name).toEqual('JULIAN BARBOSA SANTOS')
    expect(res.body[6].registrationNumber).toEqual('199604940007')
    expect(res.body[6].crg).toBeDefined()
    expect(res.body[6].course).toEqual('cbcc')
    expect(res.body[6].email).toEqual('uneccessary@ufpa.br')
    expect(res.body[6].isFit).toEqual(0)
    expect(res.body[6].isConcluding).toEqual(1)
    expect(res.body[6].isActive).toEqual(0)
    expect(res.body[6].isForming).toEqual(0)
    expect(res.body[6].isGraduating).toEqual(0)
    expect(res.body[6].academicHighlight).toEqual(0)
    expect(res.body[6].cancelled).toEqual(0)
    expect(res.body[6].prescribed).toEqual(0)
    expect(res.body[6].mailingList).toEqual('none')
    done()
  })
})
