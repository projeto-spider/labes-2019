...
describe('/api', () => {
  ...
  test('GET /', async done => {
    ...
    expect(res.body.code).toEqual(errors.NOT_FOUND_ROUTE)
    done()
  })
  ...
  test('GET /[students|users]', async done => {
    ...
    expect(resStudents.body !== { code: errors.NOT_FOUND_ROUTE }).toBeTruthy()
    ...
    expect(resUsers.body !== { code: errors.NOT_FOUND_ROUTE }).toBeTruthy()
    done()
  })
})
